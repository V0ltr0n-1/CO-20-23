...
attrib _all_ label=' ';
modify admit_instance_2;
 rename HospitalizedYesNO=admit AdmissionDate=admit_date ICU=icu /*icudate*/ died=death
		DeathDate=date_death DischargeDate=dis_date;  
contents data=ch21_msmj;
run;
	quit; 

 TestType_instance_2 CollectionDate=date_pcr pcr_result=covid_pcr_result TestingLabName=pcr_site
