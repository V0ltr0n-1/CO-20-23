...
Environment records)=data_source___2*/ MedicalRecordNumber=mrn FirstName=fname LastName=lname BirthDate=dob Age=age AgeType=age_unit Gender=sex Ethnicity=ethnic Race1=race/*NewRace=race*/
		...
		LungDiseaseID=umc___1 ChronicLiverDiseaseID=umc___2 /*DiabetesID=endo_dx___1*/ cardio=umc___4 ChronicRenalDiseaseID=umc___5 
		BloodDisorderID=umc___8 other=umc___9 ImmunocompromisedID=umc___10 UnderlyingMedicalConditionDesc=umc_other /*HypertensionID=cards_dx___4 SevereObesity=weight_dx___1 */
		PsychologicalID=psych_dx PsychologicalDesc=psych_other PregnantYesNo=gyn_dx vsmoke=personal_smoking TravelInternationalID=covid_rf___1
...
/*value mrn;change in REDcap*/
value $age_units "days"="1" "months"="2" "years"="3";
value $sex "Male"="1" "Female"="2" "Other"="3";
value $ethnic "Hispanic or Latino"="1" "Not Hispanic or Latino"="2" "Unknown or not reported"="3";
...
"White"="5" "More than one race"="6" "Unknown or not reported"="7" " "="7" "Other"="8";
value immunocomp 121=1 119=2 120=3 .=3;
value $umc_yn "Yes"="1" "No"="2" "Unknown or undocumented"="3" " "="3";
value $YESNO  "No"="0" " "="0" "Yes"="1";
/*value $umc___1  "No"="0" " "="0" "Yes"="1";
value $umc___2  "No"="0" " "="0" "Yes"="1";
value $umc___3  "No"="0" " "="0" "Yes"="1";
value $umc___4  "No"="0" " "="0" "Yes"="1";
value $umc___5  "No"="0" " "="0" "Yes"="1";
value $umc___8  "No"="0" " "="0" "Yes"="1";
value $umc___9 "No"="0" " "="0" "Yes"="1";
value covid_rf___1 "No"="0" " "="0" "Yes"="1";
value covid_rf___2 "No"="0" " "="0" "Yes"="1";
value covid_rf___9 "No"="0" " "="0" "Yes"="1";*/
value $school_daycare "Yes"="1" "No"="2" "Unknown"="3";
/*value $date_pcr MMDDYY10.; format date*/
...
/*value $sx_onset___1 "No"="0" " "="0" "Yes"="1";
value $sx_onset___2 "No"="0" " "="0" "Yes"="1"
value $sx_onset___3 "No"="0" " "="0" "Yes"="1";
value $sx_onset___4 "No"="0" " "="0" "Yes"="1";
value $sx_onset___5 "No"="0" " "="0" "Yes"="1";
value $sx_onset___6 "No"="0" " "="0" "Yes"="1";
value $sx_onset___8 "No"="0" " "="0" "Yes"="1";
value $sx_onset___9 "No"="0" " "="0" "Yes"="1";
value $sx_onset___12 "No"="0" " "="0" "Yes"="1";
value $sx_onset___13 "No"="0" " "="0" "Yes"="1";
value $sx_onset___14 "No"="0" " "="0" "Yes"="1";
value $sx_onset___15 "No"="0" " "="0" "Yes"="1";
value $sx_onset___17 "No"="0" " "="0" "Yes"="1";
value $sx_onset___18 "No"="0" " "="0" "Yes"="1";
value $sx_onset___19 "No"="0" " "="0" "Yes"="1";
value $sx_onset___20 "No"="0" " "="0" "Yes"="1";
value $sx_onset___21 "No"="0" " "="0" "Yes"="1";
value $sx_onset___22 "No"="0" " "="0" "Yes"="1";
value $sx_onset___26 "No"="0" " "="0" "Yes"="1";
value $sx_onset___25 "No"="0" " "="0" "Yes"="1";*/
value $admit "Yes"="1" "No"="2" "Unknown"="3";
value $icu "Yes"="1" "No"="2";
...
set ch21_msmj_apr2;
	...
	IF psych_other NE " "  THEN umc___11=1;
	IF endo_dx___1=1  THEN umc___3=1; 
	IF immunocomp=1 THEN umc___10=1;
	IF weight_dx___1=1 THEN umc___19=1;

format data_source__2 $DATA_SOURCE. age_units $age_units. sex $sex. ethnic $ethnic. race $race. immunocomp immunocomp. umc_yn $umc_yn.   school_daycare $school_daycare. date_pcr MMDDYY10. covid_pcr_result $covid_pcr_result.
sx_asx $sx_asx. icu $icu. death $death.  admit $admit. 
umc___1 umc___2 umc___3  umc___4 umc___5 umc___8  umc___9 sx_onset___1  sx_onset___2  sx_onset___3 sx_onset___4  sx_onset___5 sx_onset___6 sx_onset___8 
sx_onset___9 sx_onset___12  sx_onset___13 sx_onset___14 sx_onset___15 sx_onset___17  sx_onset___18 
sx_onset___19  sx_onset___20 sx_onset___21 sx_onset___22  sx_onset___26 sx_onset___25 covid_rf___1 covid_rf___2 covid_rf___9 $YESNO.
;
	RUN;
